#!/bin/bash
#
# modified from datasets/download_and_convert_voc2012.sh
#
...
# Root path for safety dataset.
#PASCAL_ROOT="${WORK_DIR}/VOCdevkit/VOC2012"
PASCAL_ROOT="${WORK_DIR}"

python ./safety_prepare_training_list.py --dataset_dir="${PASCAL_ROOT}" \
...
python ./safety_remove_colormap.py \
...
echo "Converting safety dataset..."
